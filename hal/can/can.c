...
const CAN_RX_RULE_TABLE_T tbl_can_bus_rx_rule_ch1[CAN_RX_RULE_CURRENT_AMOUNT] = 
{
    /*
                          ...
                          const CAN_RX_RULE_TABLE_T *rule)
{
    ...
    //Channel 0 Setting:
    #if 1
    for(q=0;q<CAN_RX_RULE_CURRENT_AMOUNT;q++)
    {
        //RCFDCnCFDGAFLIDj
...
void can_init(void)
{
    ...
    can_rrt_set(&RCFDC0,&can_bus_handle_ch1,tbl_can_bus_rx_rule_ch1);
